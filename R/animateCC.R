...
#' chronocoulometry simulation created using \code{ccSim}. The
#' resulting animation displays the diffusion profiles for Ox,
#' Red, and, where appropriate, Z situated above the
#' chronoamperogram. Note: the \code{animateCC} function requires
#' that the \code{animation} package is installed.
#'
#' @param filename Name of the file that contains the results of a chronocoulometry simulation.
...
#'  pulses = "double", t.2 = 20)
#'ex_cc = simulateCC(ex_ca)
#'animateCC(ex_cc, out_type = "gif", out_name = "ex_cc")
#'}
...
# verify that the file was created using ccSim
